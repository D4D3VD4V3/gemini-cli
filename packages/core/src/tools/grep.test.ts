  ...
  describe('validateToolParams', () => {
    ...
    it('should return error if pattern is missing', () => {
      ...
      expect(grepTool.validateToolParams(params)).toBe(
        `Value of params is invalid: should have required property 'pattern'`,
      );
    });
  ...
  describe('execute', () => {
    ...
    it('should return an error if params are invalid', async () => {
      ...
      expect(result.llmContent).toBe(
        "Error: Invalid parameters provided. Reason: Value of params is invalid: should have required property 'pattern'",
      );
      expect(result.returnDisplay).toBe(
        "Model provided invalid parameters. Error: Value of params is invalid: should have required property 'pattern'",
      );
    });
  });
